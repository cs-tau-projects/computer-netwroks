...
- **Flags and Messages**
    ...
    - greeting =        {"type": "greeting", "message": "Welcome! Please log in."}
...
- **functions response**
    - Parentheses: X =      {"type": "parentheses_result", "result": int(result)}
    - Lcm: X Y =            {"type": "lcm_result", "result": int(result)}
    - Caesar: plaintext X = {"type": "caesar_result", "result": bool(result)}
